...
urlpatterns = [
    ...
    path('user/list/', UserListView.as_view(),
         name='Lista de Usuários Registrados'),
    ...
    path('client/user/list/', ClientWithUserView.as_view(),
    ...
    path('vehicle/list/car',  VehicleListByCarView.as_view(),
         name='Lista de Veiculos por Carro'),
    path('vehicle/list/moto',  VehicleListByMotoView.as_view(),
         name='Lista de Veiculos por Moto'),
    path('user/update/<int:pk>',  UserUpdateView.as_view(),
         name='Atualizar Usuário'),
    path('update/rent/<uuid:pk>', RentServiceUpdateView.as_view(),
         name='Atualiza um aluguel'),
    path('delete/rent/<uuid:pk>', RentDeleteView.as_view(),
         name='Exclui um aluguel'),
    path('delete/vehicle/<uuid:pk>',
         VehicleDeleteView.as_view(), name='Exclui um veiculo')
]
